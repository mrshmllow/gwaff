...
To use it for your own server, ![fork](https://github.com/bwac2517/gwaff/fork) OR ![download it and use](https://github.com/bwac2517/gwaff/archive/master.zip) it locally.
...
minium_xp: 0 # anyone with a xp gain below this will not be included in the plots
